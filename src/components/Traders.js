...
provide exact version information in the package.json file, so that you can install these
...
detailed blog post and changelog about what is new.
...
the talks on YouTube following the events.</p>
      </div>
